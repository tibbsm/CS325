...
//  SA
//
//  Created by Marc Tibbs on 2018/03/08.
...
int main( int argc, char** argv ) {
    ...
    infile =fopen("tsp_example_1.txt","r");
    if (!infile)
        return 1;
